...
const BlogCard = ({ data }) => {
  return (
    <div className=" bg-white shadow-lg overflow-hidden rounded-xl min-w-[300px] sm:min-w-[100px] md:min-w-[210px] max-w-[300px] hover:scale-110 hover:transition-all hover:duration-300 hover:ease-in">
